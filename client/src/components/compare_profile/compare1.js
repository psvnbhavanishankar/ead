                        ...
                        <div className='row editprorows'>
                          ...
                          <div className='col-lg-9'>
                            <input
                              ...
                              name='enrollmentno'
                              value={
                                lawyerprofiles_to_compare[0].user.enrollmentno
                              }
                            />
                          </div>
                        </div>
                        ...
                        <div className='row editprorows'>
                          ...
                          <div className='col-lg-9'>
                            <input
                              ...
                              placeholder='image'
                              name='image'
                              value={lawyerprofiles_to_compare[0].user.avatar}
                            />
                          </div>
                        </div>
                        <div className='row editprorows'>
                          ...
                          <div className='col-lg-9'>
                            <div>
                              <input
                                ...
                                name='locality'
                                value={
                                  lawyerprofiles_to_compare[0].address.locality
                                }
                              />
                            </div>
                            ...
                            <div>
                              <input
                                ...
                                name='city'
                                value={
                                  lawyerprofiles_to_compare[0].address.city
                                }
                              />
                            </div>
                            ...
                            <div>
                              <input
                                ...
                                name='pincode'
                                value={
                                  lawyerprofiles_to_compare[0].address.pincode
                                }
                              />
                            </div>
                          </div>
                        ...
                        <div className='row editprorows'>
                          ...
                          <div className='col-lg-9'>
                            <input
                              ...
                              name='enrollmentno'
                              value={
                                lawyerprofiles_to_compare[1].user.enrollmentno
                              }
                            />
                          </div>
                        </div>
                        ...
                        <div className='row editprorows'>
                          ...
                          <div className='col-lg-9'>
                            <input
                              ...
                              placeholder='image'
                              name='image'
                              value={lawyerprofiles_to_compare[1].user.avatar}
                            />
                          </div>
                        </div>
                        <div className='row editprorows'>
                          ...
                          <div className='col-lg-9'>
                            <div>
                              <input
                                ...
                                name='locality'
                                value={
                                  lawyerprofiles_to_compare[1].address.locality
                                }
                              />
                            </div>
                            ...
                            <div>
                              <input
                                ...
                                name='city'
                                value={
                                  lawyerprofiles_to_compare[1].address.city
                                }
                              />
                            </div>
                            ...
                            <div>
                              <input
                                ...
                                name='pincode'
                                value={
                                  lawyerprofiles_to_compare[1].address.pincode
                                }
                              />
                            </div>
                          </div>
